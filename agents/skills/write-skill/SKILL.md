...
Write the SKILL.md file to the appropriate location:
- For personal cross-project skills, write to the agents/skills directory in your personal repo
- For project-specific skills, write to `.claude/commands/<name>.md` or the project skill directory
...
# FIXED
- Branch commits: !{git log origin/HEAD..HEAD --oneline 2>/dev/null | head -20}
```
...
**Never use `||` or `&&`** -- Claude Code permission system treats these as multiple operations and blocks them.
