...
Structured knowledge for future sessions. Each file covers a topic/domain.
...
4. Update `context/knowledge/index.md` -- add a row to the index table with the file name, topic description, key entities, and today date
